      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="glass-card glass-card-hover p-8 rounded-xl overflow-hidden relative">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                <h3 className="text-3xl font-bold text-foreground font-primary">
                  {featuredProject.title}
                </h3>
                
                <p className="text-lg text-muted-foreground leading-relaxed font-secondary">
        ...
        <div className="mt-16 text-center">
          <div className="glass-card p-8 rounded-xl">
            <h3 className="text-2xl font-bold text-foreground mb-4 font-primary">
              Want to see more?
            </h3>
