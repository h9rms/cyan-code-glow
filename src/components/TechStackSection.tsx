        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {modernTools.map((tool, index) => (
              <div key={index} className="glass-card glass-card-hover p-6 rounded-xl group relative overflow-hidden">
                {tool.featured && (
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
            {coreSkills.map((skill, index) => (
              <div key={index} className="glass-card glass-card-hover p-4 rounded-xl text-center group">
